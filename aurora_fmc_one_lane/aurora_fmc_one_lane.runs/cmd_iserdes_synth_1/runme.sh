...
HD_PWD='/home/pixdaq/kdunne/aurora_fmc_one_lane/aurora_fmc_one_lane/aurora_fmc_one_lane.runs/cmd_iserdes_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmd_iserdes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmd_iserdes.tcl
