...
HD_PWD='/home/pixdaq/kdunne/aurora_fmc_one_lane/aurora_fmc_one_lane/aurora_fmc_one_lane.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aurora_8_pair_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aurora_8_pair_top.tcl -notrace
