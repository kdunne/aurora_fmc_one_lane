...
HD_PWD='/home/pixdaq/kdunne/aurora_fmc_one_lane/aurora_fmc_one_lane/aurora_fmc_one_lane.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aurora_8_pair_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aurora_8_pair_top.tcl
